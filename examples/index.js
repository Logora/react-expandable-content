...
ReactDOM.render(
  <div style={{width: "200px", border: "1px solid #e7e7e7", borderRadius: "6px", padding: "10px"}}>
    <ExpandableContent 
      ...
      onExpand={() => console.log("%cEXPAND CONTENT", "color: green; background: #000; padding: 15px; font-size: 20px;")}
      onCollapse={() => console.log("%cCOLLAPSE CONTENT", "color: red; background: #000; padding: 15px; font-size: 20px;")}
      className="className">
